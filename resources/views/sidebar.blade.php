<section class="sidebar">
    <div class="sidebar__wrapper">
        ...
        <a href="{{ route('dashboard') }}"
           class="sidebar__button @if(request()->url() == route('dashboard') ) active @endif ">
        ...
        <a href="{{ route('clients') }}" class="sidebar__button @if(request()->url() == route('clients') ) active @endif">
            <div class="sidebar__icon">
        ...
        <a href="{{ route('notation') }}" class="sidebar__button @if(request()->url() == route('notation') ) active @endif">
            <div class="sidebar__icon">
        ...
        <a href="{{ route('settings') }}" class="sidebar__button @if(request()->url() == route('settings') ) active @endif">
            <div class="sidebar__icon">
        ...
        <a href="{{ route('statistics') }}" class="sidebar__button @if(request()->url() == route('statistics') ) active @endif">
            <div class="sidebar__icon">
